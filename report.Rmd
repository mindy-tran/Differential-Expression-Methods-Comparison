...
cat("deseq results:")
head(deseq_res)
# deseq_res[deseq_res$baseMean >= 4, ]
dim(deseq_res)
```
...
ggVennDiagram(x, set_color=c("red","green","blue")) +
  ggplot2::ggtitle("Top 1000 genes from three diff. exp. R packages")
```
...
ggVennDiagram(x, set_color=c("red","green","blue", "purple")) +
